                   ...
                   <div className="flex flex-wrap px-10">
                    ...
                    <div className="xl:w-1/2 md:w-1/2 w-full px-2">
                      ...
                      <input
                        ...
                        id="isss"
                        name="isss"
                        class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" placeholder="Si no posee ISSS dejar vacío" 
                      />
                    </div>
                    {/*AFP */}
                    <div className="xl:w-1/2 md:w-1/2 w-full px-2">
                      ...
                      <input
                        ...
                        id="afp"
                        name="afp"
                        class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" placeholder="Si no posee AFP dejar vacío"
                      />
                    </div>
                  </div>
