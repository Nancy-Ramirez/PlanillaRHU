...
export const Usuarios = () => {
  ...
  const eliminarUsuario = async (id) => {
    try
    {
      const url = `http://127.0.0.1:8000/usuarios/${id}`;
      ...
      Swal.fire(
        "Error",
        "Ocurrió un error al eliminar la usuario",
        "error"
      ); 
    };
  }
          ...
          <main className="flex">
            <section className=" w-full relative overflow-x-auto shadow-md sm:rounded-lg">
              <div className="flex justify-between pt-5">
                <div></div>
                <h1 className=" text-center text-3xl text-black">USUARIOS</h1>
                <div className="">
                              ...
                              <tr className="bg-gray-100 border-black  text-black text-center hover:bg-gray-200 hover:text-dark">
                                ...
                                <td className="px-6 py-8 text-center flex justify-center space-x-11 content-center">
                                  ...
                                  <button
                                    ...
                                    onClick={() => FuncionEliminar(usu.id)}
                                  >
